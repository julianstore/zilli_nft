...
contract ZilionixxNFT is ERC721Pausable, AccessControl, Ownable {
    ...
    constructor() public ERC721('ZILIONIXX NFT', 'ZNFT') {
    ...
    function _baseURI() internal override view returns (string memory) {
        return 'http://localhost:5000/api/v0/nft/getbyid/';
    }
